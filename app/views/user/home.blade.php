    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100"
                    src="<?= pathAssets() ?>assets/img/gallery/hero-header.png" width="470" alt="hero-header" /></div>
            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
                <h4 class="fw-bold font-sans-serif">Trở thành bậc thầy guitar</h4>
                <h1 class="fs-6 fs-xl-7 mb-5">Học guitar đệm hát cấp tốc trong vòng 30 ngày</h1><a
                ...
                <div class="card-body">
                    <div class="row flex-center gx-0">
                        <div class="col-lg-4 col-xl-2 text-center text-xl-start"><img
                                src="<?= pathAssets() ?>assets/img/gallery/funfacts.png" width="170" alt="..." /></div>
                        <div class="col-lg-8 col-xl-4">
                            <h1 class="text-light fs-lg-4 fs-xl-5">Upcoming Our <span class="text-primary">Basic
                                    in Python </span>Course!</h1>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100"><img class="card-img-top w-100"
                    ...
                    <div class="card-body">
                        <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Thiết kế hệ thống thông tin cho
                            người mới bắt đầu</h5><a class="text-muted fs--1 stretched-link text-decoration-none"
                            href="#!">The Museum of
                            Modern Art</a>
                    </div>
                </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100"><img class="card-img-top w-100"
                    ...
                    <div class="card-body">
                        <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Nâng cao khả năng phân tích ảnh</h5>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100"><img class="card-img-top w-100"
                    ...
                    <div class="card-body">
                        <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Làm sao để nhìn nhận vấn đề thực
                            tiễn hơn</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100"><img class="card-img-top w-100"
                    ...
                    <div class="card-body">
                        <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Cách tạo thời gian biểu cho chính
                            mình</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The
                            Museum of Modern Art</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="card h-100"><img class="card-img-top w-100"
                    ...
                    <div class="card-body">
                        <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Viết lách như bậc thầy văn học</h5>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100"><img class="card-img-top w-100"
                    ...
                    <div class="card-body">
                        <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">Introduction to Logic and Critical
                            Thinking</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">Duke
                            University</a>
                    </div>
                </div>
            </div>
        ...
        <div class="row h-100 align-items-center">
            <div class="col-md-12 col-lg-6 h-100">
                <div class="card card-span text-white h-100"><img class="w-100"
                        src="<?= pathAssets() ?>assets/img/gallery/student-feedback.png" alt="..." />
                        ...
                        <div class="card-body">
                            <div class="row flex-center gx-0">
                                <div class="col-lg-4 col-xl-3 text-center text-xl-start"><img
                                        src="<?= pathAssets() ?>assets/img/gallery/art-design.png" width="120"
                                        alt="courses" />
                                </div>
...
<section>
    <div class="bg-holder"
        style="background-image:url(<?= pathAssets() ?>assets/img/gallery/funfacts-2-bg.png);background-position:center;background-size:cover;">
    </div>
    <!--/.bg-holder-->
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 text-center mb-5"><img
                    src="<?= pathAssets() ?>assets/img/gallery/published.png" height="100" alt="..." />
                <h1 class="my-2">768</h1>
                <p class="text-info fw-bold">COURSES PUBLISHED</p>
            </div>
            <div class="col-sm-6 col-lg-3 text-center mb-5"><img
                    src="<?= pathAssets() ?>assets/img/gallery/instructors.png" height="100" alt="..." />
                <h1 class="my-2">120</h1>
                <p class="text-info fw-bold">EXPERT INSTRUCTORS</p>
            </div>
            <div class="col-sm-6 col-lg-3 text-center mb-5"><img
                    src="<?= pathAssets() ?>assets/img/gallery/learners.png" height="100" alt="..." />
                <h1 class="my-2">8300</h1>
                <p class="text-info fw-bold">HAPPY LEARNERS</p>
            </div>
            <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="<?= pathAssets() ?>assets/img/gallery/awards.png"
                    height="100" alt="..." />
                <h1 class="my-2">32</h1>
